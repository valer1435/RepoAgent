...
Generates system and user prompts based on the provided DocItem, enhancing existing documentation with a main idea of the project if specified.
...
Args:
    ...
    context (dict): Additional context information needed to build the prompt.
...
This function leverages language models to create creative ideas from a detailed list of components, including their names, descriptions, and hierarchical positions within the project structure.
