...
class TaskManager:
    ...
    def all_success(self) -> bool:
        ...
        Indicates whether all tasks have finished.
            ...
            Returns:
                bool: True if all tasks are successful (i.e., the task dictionary is empty),
                      False otherwise.
        """
    ...
    def get_next_task(self, process_id: int):
        """
        Assigns a ready-to-execute task to a requesting process, marking it as in progress and updating its status. Returns the task details and ID, or (None, -1) if no tasks are currently available.
