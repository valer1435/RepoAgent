...
This class intercepts log records generated by the standard Python logging module and forwards them to the Loguru logger for consistent handling, ensuring that all logs are managed uniformly across the project. This is particularly useful in a framework like Repository Agent where maintaining consistent documentation and logging practices is crucial.
...
This function intercepts a logging.LogRecord from the standard library and emits it using the Loguru logger, ensuring accurate caller information and appropriate Loguru level mapping.
