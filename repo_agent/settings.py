...
class ProjectSettings(BaseSettings):
    ...
    def validate_language_code(cls, v: str) -> str:
        """
        Ensures the provided language code is valid, returning the corresponding language name. Raises a ValueError for invalid inputs.
...
class SettingsManager:
    ...
    def get_setting(cls):
        """
        Provides access to the single instance of the configuration object.
    ...
    def initialize_with_params(
        ...
        """
        Configures the agent with project-specific details and chat completion parameters, establishing a global settings instance.
