...
class ProjectSettings(BaseSettings):
    ...
    def validate_language_code(cls, v: str) -> str:
        """
        Ensures the provided language code is valid, returning its corresponding name. Raises a ValueError for invalid inputs.
...
class SettingsManager:
    ...
    def get_setting(cls):
        """
        Provides access to the single instance of project settings.
    ...
    def initialize_with_params(
        ...
        """
        Configures the agent with project-specific details like repository path, documentation filenames, and analysis parameters, alongside settings for interacting with language models.
