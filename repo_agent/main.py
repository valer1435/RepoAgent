...
def run_outside_cli(
    ...
    Runs the documentation generation process outside of the CLI.
        ...
        Args:
            ...
            markdown_docs_path: The path to store generated markdown documentation.
...
def clean():
    ...
    Cleans up fake files.
        ...
        This method calls the delete_fake_files function to remove any generated
        dummy or temporary files and logs a success message upon completion.
...
def diff():
    ...
    Prints the documentation differences between the current state and the latest meta info.
        ...
        documentation updates, and displays a list of files to be generated or updated.
        It does not support running during an active generation process.
