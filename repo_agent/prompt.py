...
The content of the code is as follows (Def means definition, just omit it):
{code_content}
...
The {parameters_or_attribute} of this {code_type_tell}.
...
**Code Description**: 
The description of this {code_type_tell}.
(Detailed and CERTAIN code analysis and description...{has_relationship})
**Note**: 
Points to note about the use of the code
